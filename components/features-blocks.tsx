        ...
        <div className="py-12 md:py-20">
          ...
          <div className="max-w-sm mx-auto grid gap-6 md:grid-cols-2 lg:grid-cols-3 items-start md:max-w-2xl lg:max-w-none">
            ...
            <div className="relative flex flex-col items-center p-6 bg-white rounded shadow-xl">
              ...
              <h4 className="text-xl font-bold leading-snug tracking-tight mb-1">Effortless Customization</h4>
              <p className="text-gray-600 text-center">Build your dream model with a wide range of ethnicities, body types, and features. No casting calls, no scheduling conflicts - create the perfect model for every campaign in minutes.</p>
            </div>
            ...
            <div className="relative flex flex-col items-center p-6 bg-white rounded shadow-xl">
              ...
              <h4 className="text-xl font-bold leading-snug tracking-tight mb-1">Infinite Variety</h4>
              <p className="text-gray-600 text-center">Generate endless poses, expressions, and backgrounds to showcase your products in dynamic and engaging ways.</p>
            </div>
            ...
            <div className="relative flex flex-col items-center p-6 bg-white rounded shadow-xl">
              ...
              <h4 className="text-xl font-bold leading-snug tracking-tight mb-1">Cost-Effective Solution</h4>
              <p className="text-gray-600 text-center">Reduce production costs by eliminating the need for physical models, studios, and photographers.</p>
            </div>
            ...
            <div className="relative flex flex-col items-center p-6 bg-white rounded shadow-xl">
              ...
              <h4 className="text-xl font-bold leading-snug tracking-tight mb-1">Global Appeal</h4>
              <p className="text-gray-600 text-center">Cater to diverse audiences with models that represent a wider range of ethnicities and body types.</p>
            </div>
            ...
            <div className="relative flex flex-col items-center p-6 bg-white rounded shadow-xl">
              ...
              <h4 className="text-xl font-bold leading-snug tracking-tight mb-1">Sustainability</h4>
              <p className="text-gray-600 text-center">Minimize your environmental footprint by eliminating travel and physical production needs.</p>
            </div>
